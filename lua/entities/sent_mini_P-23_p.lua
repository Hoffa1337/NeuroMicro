...
ENT.ControlSurfaces  = {
	Elevator = { 
			Mdl = "models/killstr3aks/neuroplanes/american/p23_elevators.mdl", 
			Pos = Vector(-31.6,0,.4 ),
			Ang = Angle( 0,0,0 )
			};
	Rudder = {	
			Mdl = "models/killstr3aks/neuroplanes/american/p23_rudder.mdl",
			Pos = Vector(-31.5,0,2.6),
			Ang = Angle( 0,0,0 )
			};
	Ailerons = {
			{
			Mdl = "models/killstr3aks/neuroplanes/american/p23_aileron_l.mdl",
			Pos = Vector(2.4,29.7,7.7),
			Ang = Angle( 0,-9.7,.3)
			};
			{
			Mdl = "models/killstr3aks/neuroplanes/american/p23_aileron_r.mdl",
			Pos = Vector(2.4,-29.7,7.7),
			Ang = Angle( 0,9.7,-.3 )
			};
		};
...
ENT.Model 			= "models/killstr3aks/neuroplanes/american/p23_body.mdl"
ENT.TailModel 		= "models/killstr3aks/neuroplanes/american/p23_tail.mdl"
ENT.WingModels 		= { "models/killstr3aks/neuroplanes/american/p23_wing_l.mdl", 
						"models/killstr3aks/neuroplanes/american/p23_wing_r.mdl" }
ENT.PropellerModel 	= "models/killstr3aks/neuroplanes/american/p23_propeller.mdl"
...
ENT.PitchValue = 8.97					-- how fast we rise / dive
...
ENT.TailLiftMultiplier = 40        -- Wing Mass / Mult * Velocity -- lift coefficient 
ENT.WingLiftMultiplier = 60		    -- tail lift coefficient
ENT.MaxVelocity = 1.9 * 390			-- Top speed in km/h
...
ENT.MinigunPos = {  Vector( -16, -5, 0 ),Vector( -16, 5, 0 ),Vector( -16, 5, 2 ),Vector( -16, -5, 2 )  }
...
ENT.CameraUp = 3
ENT.TinySmoke = true
ENT.CockpitPosition = Vector( -7, 0, 6 )
...
ENT.WheelMass = 4000
ENT.WheelPos = { Vector( 10, -.2, -13 ),Vector( 10, .2, -13 )  }
ENT.WheelModels = {"models/killstr3aks/neuroplanes/american/p23_wheel_r.mdl",
					"models/killstr3aks/neuroplanes/american/p23_wheel_l.mdl"}
ENT.EngineSounds = {
