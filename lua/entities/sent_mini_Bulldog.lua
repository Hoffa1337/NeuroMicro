...
ENT.ControlSurfaces  = {
	Elevator = { 
			Mdl = "models/killstr3aks/neuroplanes/british/bulldog_elevators.mdl", 
			Pos = Vector(-40.2,0,2.5 ),
			Ang = Angle( 0,0,0 )
			};
	Rudder = {	
			Mdl = "models/killstr3aks/neuroplanes/british/bulldog_rudder.mdl",
			Pos = Vector(-41.7,0,1.6),
			Ang = Angle( 0,0,0 )
			};
	Ailerons = {
			{
			Mdl = "models/killstr3aks/neuroplanes/british/bulldog_aileron_l.mdl",
			Pos = Vector(-7,31.15,10.3),
			Ang = Angle( 0,0,4.65)
			};
			{
			Mdl = "models/killstr3aks/neuroplanes/british/bulldog_aileron_r.mdl",
			Pos = Vector(-7,-31.15,10.3),
			Ang = Angle( 0,0,-4.65 )
			};
		};
...
ENT.Model 			= "models/killstr3aks/neuroplanes/british/bulldog_body.mdl"
ENT.TailModel 		= "models/killstr3aks/neuroplanes/british/bulldog_tail.mdl"
ENT.WingModels 		= { "models/killstr3aks/neuroplanes/british/bulldog_wing_l.mdl", 
						"models/killstr3aks/neuroplanes/british/bulldog_wing_r.mdl" }
ENT.PropellerModel 	= "models/killstr3aks/neuroplanes/british/bulldog_propeller.mdl"
...
ENT.MinigunPos = {  Vector( -27, -5, 3 ),Vector( -27, 5, 3 )  }
...
ENT.CameraUp = 3
ENT.TinySmoke = true
ENT.CockpitPosition = Vector( -7.8, 0, 7.4 )
...
ENT.WheelMass = 2400
ENT.WheelPos = { Vector( 2, 0, -11 ),Vector( 2, 0, -11 )  }
ENT.WheelModels = {"models/killstr3aks/neuroplanes/british/bulldog_wheel_r.mdl",
					"models/killstr3aks/neuroplanes/british/bulldog_wheel_l.mdl"}
ENT.EngineSounds = {
