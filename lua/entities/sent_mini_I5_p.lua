...
ENT.ControlSurfaces  = {
	Elevator = { 
			Mdl = "models/killstr3aks/neuroplanes/russian/I5_elevators.mdl", 
			Pos = Vector(-23.5,0,3.5 ),
			Ang = Angle( 0,0,0 )
			};
	Rudder = {	
			Mdl = "models/killstr3aks/neuroplanes/russian/I5_rudder.mdl",
			Pos = Vector(-25.2,0,3),
			Ang = Angle( 0,0,0 )
			};
	Ailerons = {
			{
			Mdl = "models/killstr3aks/neuroplanes/russian/I5_aileron_l.mdl",
			Pos = Vector(4.9,26.2,9.9),
			Ang = Angle( 0,2,3 )
			};
			{
			Mdl = "models/killstr3aks/neuroplanes/russian/I5_aileron_r.mdl",
			Pos = Vector(4.9,-26.2,9.9),
			Ang = Angle( 0,-2,-3 )
			};
		};
...
ENT.Model 			= "models/killstr3aks/neuroplanes/russian/I5_body.mdl"
ENT.TailModel 		= "models/killstr3aks/neuroplanes/russian/I5_tail.mdl"
ENT.WingModels 		= { "models/killstr3aks/neuroplanes/russian/I5_wing_l.mdl", 
						"models/killstr3aks/neuroplanes/russian/I5_wing_r.mdl" }
ENT.PropellerModel 	= "models/killstr3aks/neuroplanes/russian/I5_propeller.mdl"
...
ENT.PitchValue = 5.2					-- how fast we rise / dive
...
ENT.CameraUp = 3
ENT.TinySmoke = true
ENT.CockpitPosition = Vector( 0, 0, 7 )
...
ENT.WheelMass = 2260
ENT.WheelPos = { Vector( 13.5, 0, -12 ),Vector( 13.5, 0, -12 )  }
