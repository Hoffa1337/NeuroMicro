...
ENT.ControlSurfaces  = {
	Elevator = { 
			Mdl = "models/killstr3aks/neuroplanes/german/ar_65_elevators.mdl", 
			Pos = Vector(-37.2,0,7.5 ),
			Ang = Angle( 0,0,0 )
			};
	Rudder = {	
			Mdl = "models/killstr3aks/neuroplanes/german/ar_65_rudder.mdl",
			Pos = Vector(-39,0,-0.4),
			Ang = Angle( 0,0,0 )
			};
	Ailerons = {
			{
			Mdl = "models/killstr3aks/neuroplanes/german/ar_65_aileron_1l.mdl",
			Pos = Vector(1.5,30,12.7),
			Ang = Angle( 0,0,3.5 )
			};
			{
			Mdl = "models/killstr3aks/neuroplanes/german/ar_65_aileron_1r.mdl",
			Pos = Vector(1.5,-30,12.7),
			Ang = Angle( 0,0,-3.5 )
			};
			{
			Mdl = "models/killstr3aks/neuroplanes/german/ar_65_aileron_2l.mdl",
			Pos = Vector(-4,26,-3),
			Ang = Angle( 0,0,1.5 )
			};
			{
			Mdl = "models/killstr3aks/neuroplanes/german/ar_65_aileron_2r.mdl",
			Pos = Vector(-4,-26,-3),
			Ang = Angle( 0,0,-1.5 )
			};
		};
...
ENT.Model 			= "models/killstr3aks/neuroplanes/german/ar_65_body.mdl"
ENT.TailModel 		= "models/killstr3aks/neuroplanes/german/ar_65_tail.mdl"
ENT.WingModels 		= { "models/killstr3aks/neuroplanes/german/ar_65_wing_l.mdl", 
						"models/killstr3aks/neuroplanes/german/ar_65_wing_r.mdl" }
ENT.PropellerModel 	= "models/killstr3aks/neuroplanes/german/ar_65_propeller.mdl"
...
ENT.TailLiftMultiplier = 24        -- Wing Mass / Mult * Velocity -- lift coefficient 
...
ENT.CameraUp = 3
ENT.TinySmoke = true
ENT.CockpitPosition = Vector( -4, 0, 9.3 )
...
ENT.WheelModels = {"models/killstr3aks/neuroplanes/german/ar_65_wheel_r.mdl",
					"models/killstr3aks/neuroplanes/german/ar_65_wheel_l.mdl"}
ENT.EngineSounds = {
