...
ENT.ControlSurfaces  = {
	Elevator = { 
			Mdl = "models/killstr3aks/neuroplanes/british/demon_elevators.mdl", 
			Pos = Vector(-40.8,0,1.6 ),
			Ang = Angle( 0,0,0 )
			};
	Rudder = {	
			Mdl = "models/killstr3aks/neuroplanes/british/demon_rudder.mdl",
			Pos = Vector(-41.5,0,4.2),
			Ang = Angle( 0,0,0 )
			};
	Ailerons = {
			{
			Mdl = "models/killstr3aks/neuroplanes/british/demon_aileron_l.mdl",
			Pos = Vector(-1.5,30.5,8.1),
			Ang = Angle( 0,4.7,0)
			};
			{
			Mdl = "models/killstr3aks/neuroplanes/british/demon_aileron_r.mdl",
			Pos = Vector(-1.5,-30.5,8.1),
			Ang = Angle( 0,-4.7,0 )
			};
		};
...
ENT.Model 			= "models/killstr3aks/neuroplanes/british/demon_body.mdl"
ENT.TailModel 		= "models/killstr3aks/neuroplanes/british/demon_tail.mdl"
ENT.WingModels 		= { "models/killstr3aks/neuroplanes/british/demon_wing_l.mdl", 
						"models/killstr3aks/neuroplanes/british/demon_wing_r.mdl" }
ENT.PropellerModel 	= "models/killstr3aks/neuroplanes/british/demon_propeller.mdl"
...
ENT.TailLiftMultiplier = 49.5        -- Wing Mass / Mult * Velocity -- lift coefficient 
ENT.WingLiftMultiplier = 60		    -- tail lift coefficient
ENT.MaxVelocity = 1.9 * 370			-- Top speed in km/h
...
ENT.MinigunPos = {  Vector( -27, -5, 0 ),Vector( -27, 5, 0 )  }
...
ENT.CameraUp = 3
ENT.TinySmoke = true
ENT.CockpitPosition = Vector( -3, 0, 6.2 )
...
ENT.WheelMass = 2260
ENT.WheelPos = { Vector( 6, -.2, -13 ),Vector( 6, .2, -13 )  }
ENT.WheelModels = {"models/killstr3aks/neuroplanes/british/demon_wheel_r.mdl",
					"models/killstr3aks/neuroplanes/british/demon_wheel_l.mdl"}
ENT.EngineSounds = {
...
if( SERVER ) then
	...
	function ENT:PhysicsSimulate( phys, deltatime ) 
		...
		-- if( self:GetVelocity():Length() > self.MaxVelocity / 2 ) then
			...
			self:GetPhysicsObject():AddAngleVelocity( Vector( 0, -9, 0 )  * 1.0 * ( self.CurVelocity  / self.MaxVelocity ) ) 
