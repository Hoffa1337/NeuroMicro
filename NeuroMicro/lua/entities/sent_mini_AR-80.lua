...
ENT.ControlSurfaces  = {
	Elevator = { 
			Mdl = "models/killstr3aks/neuroplanes/german/ar80_elevators.mdl", 
			Pos = Vector(-66.7,0,0.4 ),
			Ang = Angle( 0,0,0 )
			};
	Rudder = {	
			Mdl = "models/killstr3aks/neuroplanes/german/ar80_rudder.mdl",
			Pos = Vector(-58.7,0,8.8),
			Ang = Angle( 0,0,0 )
			};
	Ailerons = {
			{
			Mdl = "models/killstr3aks/neuroplanes/german/ar80_aileron_l.mdl",
			Pos = Vector(-16,30.4,-2),
			Ang = Angle( 0,-7,5 )
			};
			{
			Mdl = "models/killstr3aks/neuroplanes/german/ar80_aileron_r.mdl",
			Pos = Vector(-16,-30.4,-2),
			Ang = Angle( 0,7,-5 )
			};
		};
...
ENT.Model 			= "models/killstr3aks/neuroplanes/german/ar80_body.mdl"
ENT.TailModel 		= "models/killstr3aks/neuroplanes/german/ar80_tail.mdl"
ENT.WingModels 		= { "models/killstr3aks/neuroplanes/german/ar80_wing_l.mdl", 
						"models/killstr3aks/neuroplanes/german/ar80_wing_r.mdl" }
ENT.PropellerModel 	= "models/killstr3aks/neuroplanes/german/ar80_propeller.mdl"
...
ENT.ClimbPunishmentMultiplier = 70	-- How fast we gain speed. Higher value faster acceleration / deceleration
...
ENT.PitchValue = 4.7					-- how fast we rise / dive
...
ENT.TailLiftMultiplier = -90	    -- Wing Mass / Mult * Velocity -- lift coefficient 
ENT.WingLiftMultiplier = 50	    -- tail lift coefficient
ENT.MaxVelocity = 1.9 * 500			-- Top speed in km/h
...
ENT.BankForce = 380					-- Aileron / banking force Unit/s
ENT.AxledWheels = true           -- Use axis instead of weld?
ENT.WheelMass = 1450				-- Wheel weight
-- ENT.BankForceDivider = 0.5
ENT.PitchForceDivider = 1.75
ENT.YawForceDivider = 0.3925
...
ENT.CameraUp = 3
ENT.TinySmoke = true
ENT.CockpitPosition = Vector( -15, .5, 5 )
...
ENT.ExhaustPos = { 
Vector( 25-20,4,-2 ), Vector( 25-20, -4, -2 ),
Vector( 27-20,4,-2 ), Vector( 27-20, -4, -2 ),
Vector( 30-20,4,-2 ), Vector( 30-20, -4, -2 )}
ENT.WheelPos = { Vector( -2, -19.3, -13 ),Vector( -2, 19.3, -13 )  }
ENT.WheelModels = {"models/killstr3aks/neuroplanes/german/ar80_wheel_l.mdl","models/killstr3aks/neuroplanes/german/ar80_wheel_r.mdl"}
ENT.EngineSounds = {
	...
	function ENT:PhysicsSimulate( phys, deltatime ) 
		...
		if( IsValid( self.Pilot ) && !self.Destroyed && self.CurVelocity ) then
			...
			if( self:GetVelocity():Length() > self.MaxVelocity / 4 ) then
				...
				self:GetPhysicsObject():AddAngleVelocity( Vector( 5.5, 0, -.25 ) * 1.0 * ( self.CurVelocity  / self.MaxVelocity ) ) 
